...
const AuthModal = ({ isOpen, onClose, initialMode = 'signin' }) => {
    const { signInWithGoogle, signInWithEmail, signUpWithEmail, resetPasswordForEmail, updateUserPassword, setRecoveryMode } = useAuth();
    ...
    const validateForm = () => {
        ...
        // Confirm password validation (for signup and reset)
                ...
                <div className="auth-left">
                    ...
                    <div className="auth-header">
                        ...
                        <h2 className="auth-title">
                            {mode === 'confirm' || mode === 'confirm_reset' ? 'Check Your Email'
                        ...
                        <p className="auth-subtitle">
                            {mode === 'confirm' || mode === 'confirm_reset'
                        ...
                        <>
                            ...
                            <form className="auth-form" onSubmit={handleSubmit} autoComplete="off">
                                ...
                                {mode === 'signin' && (
                                    <div className="auth-extras">
                                        ...
                                        <button type="button" className="auth-forgot" onClick={() => { setMode('forgot_password'); setAuthError(''); setFieldErrors({}); }}>Forgot password?</button>
                                    </div>
                                )}
                            ...
                            {(mode === 'forgot_password' || mode === 'reset_password') && (
                                <p className="auth-switch">
                                    ...
                                    <button type="button" className="auth-switch-btn" onClick={() => { setMode('signin'); setAuthError(''); }} disabled={authLoading}>
                                        Sign In
                                    </button>
                                </p>
                            )}
